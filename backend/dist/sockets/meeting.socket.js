...
export const setupMeetingSockets = (io) => {
    ...
    io.use(async (socket, next) => {
        try {
            ...
            if (!token) {
                ...
                const roomSlug = socket.handshake.query.roomSlug;
...
const addParticipantToRoom = async (socket, roomId, role, isMuted, isCameraOff) => {
...
//# sourceMappingURL=meeting.socket.js.map